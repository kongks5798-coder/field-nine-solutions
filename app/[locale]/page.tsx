...
const translations: Record<string, TranslationType> = {
  ko: {
    ...
    services: {
      ...
      earlyAccess: '베타',
      items: [
        { icon: 'Building2', name: '호텔 예약', desc: '전 세계 최저가 비교', benefit: '최대 15% 할인', status: 'beta' },
        { icon: 'Plane', name: '항공권 검색', desc: '실시간 최저가 비교', benefit: '가격 알림 무료', status: 'beta' },
        { icon: 'Banknote', name: '실시간 환율', desc: '은행 환율 실시간 비교', benefit: '최적 환전 타이밍', status: 'live' },
      ],
      notify: '출시 알림 받기',
  ...
  en: {
    ...
    services: {
      ...
      earlyAccess: 'Beta',
      items: [
        { icon: 'Building2', name: 'Hotels', desc: 'Compare best prices worldwide', benefit: 'Up to 15% off', status: 'beta' },
        { icon: 'Plane', name: 'Flights', desc: 'Real-time fare comparison', benefit: 'Price alerts free', status: 'beta' },
        { icon: 'Banknote', name: 'Exchange Rates', desc: 'Live bank rates comparison', benefit: 'Best timing alerts', status: 'live' },
      ],
      notify: 'Get Notified',
