...
const translations: Record<string, TranslationType> = {
  ko: {
    ...
    hero: {
      ...
      cta: '무료로 시작하기',
      ctaSecondary: '앱 미리보기',
      trustBadges: ['실시간 환율', '최저가 비교', '무료 서비스'],
    },
    stats: [
    ...
    services: {
      badge: '핵심 서비스',
      title: '해외여행 필수 3가지',
      subtitle: '호텔, 항공, 환전 - 가장 중요한 것만 완벽하게',
      earlyAccess: '베타',
      items: [
        { icon: 'Building2', name: '호텔 예약', desc: '전 세계 최저가 비교', benefit: '최대 15% 할인', status: 'beta', href: '/dashboard/hotels' },
        { icon: 'Plane', name: '항공권 검색', desc: '실시간 최저가 비교', benefit: '가격 알림 무료', status: 'beta', href: '/dashboard/airport' },
        { icon: 'Banknote', name: '실시간 환율', desc: '은행 환율 실시간 비교', benefit: '최적 환전 타이밍', status: 'live', href: '/dashboard/exchange' },
      ],
      notify: '출시 알림 받기',
      notifyDesc: '새 기능 출시 시 가장 먼저 알려드려요',
    },
    ai: {
      badge: 'AI 여행 도우미',
  ...
  en: {
    ...
    hero: {
      ...
      trustBadges: ['Live Rates', 'Best Prices', 'Free Service'],
    },
    stats: [
    ...
    services: {
      ...
      subtitle: 'Hotels, Flights, Exchange - The 3 things that matter most',
      earlyAccess: 'Beta',
      items: [
        { icon: 'Building2', name: 'Hotels', desc: 'Compare best prices worldwide', benefit: 'Up to 15% off', status: 'beta', href: '/dashboard/hotels' },
        { icon: 'Plane', name: 'Flights', desc: 'Real-time fare comparison', benefit: 'Price alerts free', status: 'beta', href: '/dashboard/airport' },
        { icon: 'Banknote', name: 'Exchange Rates', desc: 'Live bank rates comparison', benefit: 'Best timing alerts', status: 'live', href: '/dashboard/exchange' },
      ],
      notify: 'Get Notified',
      notifyDesc: "Be the first to know when new features launch",
    },
    ai: {
    ...
    reviews: {
      ...
      subtitle: 'Real feedback from beta testers',
      items: [
