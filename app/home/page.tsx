...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500 selection:text-white overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-md bg-black/60 border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium text-gray-400">
            ...
            <a href="#technology" className="hover:text-white transition-colors">테크놀로지</a>
            <a href="#pricing" className="hover:text-white transition-colors">구독 요금제</a>
            <a href="#support" className="hover:text-white transition-colors">고객지원</a>
          </div>
          <div className="flex gap-4">
            <a href="/login" className="text-sm font-medium hover:text-white text-gray-400 py-2 transition-colors">
              로그인
            </a>
            <a href="/neural-nine" className="text-sm font-medium bg-white text-black px-5 py-2 rounded-full hover:bg-gray-200 transition-colors flex items-center gap-1">
      ...
      <section className="relative pt-36 pb-20 md:pt-52 md:pb-32 px-6 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <a href="/neural-nine" className="group flex items-center justify-center gap-2 bg-white text-black px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-200 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all">
              무료로 시작하기
      ...
      <section id="solutions" className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl bg-[#111] border border-white/5 hover:border-white/20 transition-all group hover:-translate-y-1 duration-300">
            ...
            <a href="/neural-nine" className="text-yellow-500 text-sm font-bold flex items-center gap-1 hover:gap-2 transition-all">
          ...
          <div className="p-8 rounded-3xl bg-[#111] border border-white/5 hover:border-white/20 transition-all group hover:-translate-y-1 duration-300">
            ...
            <a href="/dashboard/settings" className="text-blue-500 text-sm font-bold flex items-center gap-1 hover:gap-2 transition-all">
          ...
          <div className="p-8 rounded-3xl bg-[#111] border border-white/5 hover:border-white/20 transition-all group hover:-translate-y-1 duration-300">
            ...
            <a href="/dashboard" className="text-emerald-500 text-sm font-bold flex items-center gap-1 hover:gap-2 transition-all">
      ...
      {/* --- Subscription CTA --- */}
      <section id="pricing" className="py-32 px-6 bg-gradient-to-b from-black to-[#050505] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-6 items-center">
             <div className="p-0.5 rounded-full bg-gradient-to-r from-blue-500 to-emerald-500 shadow-lg shadow-blue-500/20">
                <a href="/neural-nine" className="bg-black text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-[#111] transition-colors w-full sm:w-auto block">
                  무료 체험 시작하기
                </a>
             </div>
             <a href="/contact" className="text-gray-400 hover:text-white transition-colors underline decoration-gray-700 underline-offset-4">
               엔터프라이즈 문의하기
             </a>
          </div>
      ...
      {/* --- Footer --- */}
      <footer id="support" className="py-12 px-6 border-t border-white/10 bg-black text-gray-600 text-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a href="/pricing" className="hover:text-white transition-colors">이용약관</a>
            <a href="/contact" className="hover:text-white transition-colors">개인정보처리방침</a>
            <a href="/dashboard" className="hover:text-white transition-colors">서비스 상태</a>
          </div>
