...
const nextConfig: NextConfig = {
  ...
  async headers() {
    ...
    const cspHeader = [
      ...
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.tosspayments.com https://*.sentry.io https://www.google-analytics.com",
    ...
    return [
      ...
      // API routes - more permissive for JSON responses
      {
        source: '/api/:path*',
        headers: [
          {
