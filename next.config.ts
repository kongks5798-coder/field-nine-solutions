...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const csp = [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://js.tosspayments.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://unpkg.com",
