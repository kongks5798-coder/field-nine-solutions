...
- [x] **결제 영수증 이메일** — Toss webhook 성공 시 Resend로 영수증 자동 발송
- [x] **플랜 업그레이드/다운그레이드 UI** — 현재 새 구독만 가능, 변경 불가
- [x] **구독 취소 플로우** — 취소 사유 수집 + 혜택 제시 후 취소
...
- [x] **프롬프트 갤러리** — "이런 앱 만들 수 있어요" 예시 10개 (홈페이지)
- [x] **앱 카테고리 필터** — 쇼케이스에서 게임/유틸/비즈니스/교육 필터
- [x] **공유 OG 이미지 개선** — 앱 스크린샷 기반 OG (현재 텍스트만)
